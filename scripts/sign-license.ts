 ...
 *
 * Usage: bun run scripts/sign-license.ts [email] [plan] [days]
 *
 * Examples:
 *   bun run scripts/sign-license.ts                          # defaults
 *   bun run scripts/sign-license.ts user@example.com pro 365
 *   bun run scripts/sign-license.ts test@dev.local pro 30
 */
